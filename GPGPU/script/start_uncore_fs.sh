...
python3 exp_power_motif.py --suite 0 --test 0  --dynamic_ufs_gpuP 0 --dynamic_ufs_mem 1 --uncore_0 0.8 --uncore_1 0.8 --pcm 1 --inc_ts 100 --dec_ts 500 --history 5 --dual_cap 0 --burst_up 0.4 --burst_low 0.2  --benchmark lammps
